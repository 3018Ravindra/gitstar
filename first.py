...
# my second program in python (Pthong Indentation)
if 5 > 2:
    print("five is greater than two")

 #my third program is python variable
x = 5
y = "hello world"
print(x)
print(y)

#my fourth pragram in python is python comments
#this is a comment 
...
# my eighteenth program in python is python string formatting with f-string
name = "ravi"
age = 25
